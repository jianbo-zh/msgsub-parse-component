...
import datadecode.dealer.html as pyhtml
import datadecode.dealer.json as jpath
import datadecode.dealer.xml as xmlpath
...
xx = xmlpath.handler(bytes(xmlstr, encoding="utf-8"), ['//name/text()'])
